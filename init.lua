...
do
  ...
  local servers = {
    ...
    --
    -- But for many setups, the LSP (`ts_ls` / `tsgo`) will work just fine
    tailwindcss = {
    ...
    -- Native (Go) port of tsserver: much faster diagnostics, monorepo-aware.
    -- Feature set is still partial vs `ts_ls` (no code actions / organize imports yet).
    tsgo = {
      filetypes = { 'typescript', 'javascript', 'javascriptreact', 'typescriptreact' },
    },
